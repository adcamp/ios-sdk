...
#import <ADCampSDK/ADCMoviePlayer.h>

@interface ADCPlayerViewController () {
...
- (void)doLayout {
	player.frame = CGRectMake(5, 5, self.view.bounds.size.width - 10, self.view.bounds.size.height - 5 - 44 - 20);
}
